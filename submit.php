<?PHP
	...
	$headers = "From: FormMailer@jessyj.loreal@gmail.com". "\r\n" .			
				"Reply-To: FormMailer@jessyj.loreal@gmail.com" . "\r\n"; #set the from address 
	...
	mail($to, $subject, $msg, $headers, " -fFormMailer@jessyj.loreal@gmail.com"); 
	if ($forward == 1) { 
